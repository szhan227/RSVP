...
def first_stage_train(rank, model, opt, d_opt, criterion, train_loader, test_loader, first_model, fp, logger=None):
    ...
    if fp:
        '''GradScaler is a class that can be used to scale gradients during training. 
        This can help to improve the stability of training and can also reduce the amount of memory required.
        '''
        scaler = GradScaler()
        scaler_d = GradScaler()
