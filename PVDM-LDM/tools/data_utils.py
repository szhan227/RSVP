...
'''
The InfiniteSampler class is a useful class for sampling from datasets that are too large to fit in memory. 
The InfiniteSampler class can also be used to generate samples for training neural networks.
'''
