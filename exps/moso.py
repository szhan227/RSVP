...
def moso_diffusion(rank, args):
    ...
    train_loader, _, test_loader, _ = get_dataloader(args.opt):
    ...
    mosoDDPM(rank, first_stage_model, model, opt, criterion, train_loader, test_loader, lr_scheduler, ema_model, cond_prob, logger, gamma)
