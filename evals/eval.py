...
def test_fvd_moso(rank, ema_model, first_stage_model, loader, it, logger=None):
    ...
    with torch.no_grad():        
        ...
        for i in range(4):         
            ...
            # print(x_rec[0][0])
            # cv2.imwrite(os.path.join("/export2/xu1201/RSVP/results/moso_ddpm_main_UCF-101_42", "debug.png"), x_rec[0][0])
            # x_rec.save(os.path.join("/export2/xu1201/RSVP/results/moso_ddpm_main_UCF-101_42", "debug.png"))
            # assert False, os.path.join(logger.logdir, "debug.png")
