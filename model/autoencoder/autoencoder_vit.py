...
from model.autoencoder.vit_modules import TimeSformerEncoder, TimeSformerDecoder
...
if __name__ == '__main__':
    ...
    #              monitor=None,
    #              ):
    ae_config_path = '../../config/pvdm_vae_base.yaml'
    ae_config = OmegaConf.load(ae_config_path).model.params
    print(ae_config)
    # AE = ViTAutoencoder()